package org.polyfrost.elementa
 ...
 * [org.polyfrost.elementa.components.Window]s. This allows Elementa to evolve without breaking mods which rely on old,
 * suboptimal behavior.
 *
 * This opt-in, if supplied to [org.polyfrost.elementa.components.Window]'s constructor, will only be active during the
...
enum class ElementaVersion {
    ...
    /**
     * [org.polyfrost.elementa.components.UIBlock.drawBlock] and the similar methods all starting with `drawBlock` will
     ...
     * in [org.polyfrost.elementa.WindowScreen.onMouseClicked] if it is not already present
     *
     ...
     * In particular, [org.polyfrost.elementa.components.Window.mouseClick] will add half a real pixel to the passed
     * coordinates and [org.polyfrost.elementa.UIComponent.getMousePosition] will add half a real pixel to the returned
     * coordinates.
     ...
     * [org.polyfrost.elementa.utils.guiHint].
     ...
     *
     * 3. [org.polyfrost.elementa.components.Window] will now call the new [org.polyfrost.elementa.UIComponent.dragMouse]
    ...
    /**
     * When there are multiple [org.polyfrost.elementa.effects.Effect] applied to a single component, their [org.polyfrost.elementa.effects.Effect.afterDraw]
    ...
    /**
     * Mark components as initialized and call [org.polyfrost.elementa.UIComponent.afterInitialization] during `beforeDraw` instead of `draw`.
     *
     * This ensures that [org.polyfrost.elementa.effects.Effect.setup] is always called before [org.polyfrost.elementa.effects.Effect.beforeDraw].
     * On prior versions, calling [org.polyfrost.elementa.UIComponent.enableEffect] on a component that wasn't yet initialized would result
    ...
    /**
     * [org.polyfrost.elementa.components.ScrollComponent] now has a minimum size for scrollbar grips.
     */
    V6,
