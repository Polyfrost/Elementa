...
import org.polyfrost.elementa.events.UIClickEvent
...
import org.polyfrost.elementa.constraints.animation.*
import org.polyfrost.elementa.utils.*
import org.polyfrost.elementa.utils.handleInvalidUsage
import org.polyfrost.elementa.utils.requireMainThread
import org.polyfrost.elementa.utils.requireState
...
abstract class UIComponent : Observable(), ReferenceHolder {
     ...
     *
     * A convenient Kotlin wrapper can be found at [org.polyfrost.elementa.dsl.animate]
     */
     ...
     *
     * This is handled internally by the org.polyfrost.elementa.dsl.animate] dsl if used.
     */
