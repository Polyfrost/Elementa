...
import org.polyfrost.elementa.events.UIScrollEvent
import org.polyfrost.elementa.utils.bindLast
...
class ScrollComponent constructor(
    ...
    private val mouseScrollLambda: UIComponent.(UIScrollEvent) -> Unit = {
        if (Window.of(this).version >= org.polyfrost.elementa.ElementaVersion.v5) {
            // new behavior
    ...
    override fun draw(matrixStack: UMatrixStack) {
        ...
        if (needsUpdate) {
            ...
            actualHolder.animate {
                ...
                setXAnimation(org.polyfrost.elementa.constraints.animation.Animations.IN_SIN, 0.1f, horizontalOffset.pixels())
                setYAnimation(org.polyfrost.elementa.constraints.animation.Animations.IN_SIN, 0.1f, verticalOffset.pixels())
            }
    ...
    private fun updateScrollBar(scrollPercentage: Float, percentageOfParent: Float, isHorizontal: Boolean) {
        ...
        component.animate {
            if (isHorizontal) {
                setXAnimation(
                    org.polyfrost.elementa.constraints.animation.Animations.IN_SIN, 0.1f, basicXConstraint { component ->
                ...
                setYAnimation(
                    org.polyfrost.elementa.constraints.animation.Animations.IN_SIN, 0.1f, basicYConstraint { component ->
