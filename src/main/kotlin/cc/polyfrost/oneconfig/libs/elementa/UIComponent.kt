...
abstract class UIComponent : Observable(), ReferenceHolder {
     ...
     *
     * A convenient Kotlin wrapper can be found at [cc.polyfrost.oneconfig.libs.elementa.dsl.animate]
     */
     ...
     *
     * This is handled internally by the cc.polyfrost.oneconfig.libs.elementa.dsl.animate] dsl if used.
     */
