package cc.polyfrost.oneconfig.libs.elementa.state
 ...
 * for example usage.
 *
 * @see cc.polyfrost.oneconfig.libs.elementa.state.state
 * @see cc.polyfrost.oneconfig.libs.elementa.state.map
 * @see cc.polyfrost.oneconfig.libs.elementa.state.zip
 */
