package cc.polyfrost.oneconfig.libs.elementa
 ...
 * [cc.polyfrost.oneconfig.libs.elementa.components.Window]s. This allows Elementa to evolve without breaking mods which rely on old,
 * suboptimal behavior.
 *
 * This opt-in, if supplied to [cc.polyfrost.oneconfig.libs.elementa.components.Window]'s constructor, will only be active during the
...
enum class ElementaVersion {
    ...
    /**
     * [cc.polyfrost.oneconfig.libs.elementa.components.UIBlock.drawBlock] and the similar methods all starting with `drawBlock` will
     ...
     * in [cc.polyfrost.oneconfig.libs.elementa.WindowScreen.onMouseClicked] if it is not already present
     *
     ...
     * In particular, [cc.polyfrost.oneconfig.libs.elementa.components.Window.mouseClick] will add half a real pixel to the passed
     * coordinates and [cc.polyfrost.oneconfig.libs.elementa.UIComponent.getMousePosition] will add half a real pixel to the returned
     * coordinates.
     ...
     * [cc.polyfrost.oneconfig.libs.elementa.utils.guiHint].
     ...
     *
     * 3. [cc.polyfrost.oneconfig.libs.elementa.components.Window] will now call the new [cc.polyfrost.oneconfig.libs.elementa.UIComponent.dragMouse]
