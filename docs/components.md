...
The [UIContainer](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIContainer.kt) component is the simplest of
...
[UIBlock](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIBlock.kt) is another extremely basic, but frequently used 
...
[UIText](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIText.kt) being the simpler,
...
the [UIWrappedText](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIWrappedText.kt) component will do the trick.
...
[UIRoundedRectangle](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIRoundedRectangle.kt)s are an alternative
...
### Gradient
[GradientComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/GradientComponent.kt)s are another alternative 
...
[UICircle](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UICircle.kt)s are an interesting component in that they
...
The [UIShape](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIShape.kt) component also works differently from
most other components. A shape itself has no position, nor a size. Instead, it has a series of
[UIPoint](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIPoint.kt) elements that describe the shape it should draw.
...
[UIImage](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/UIImage.kt) that can render a simple png, jpeg, etc.
...
providing a custom [ImageProvider](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/image/ImageProvider.kt).
...
A [BlurHashImage](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/image/BlurHashImage.kt) is a placeholder or
...
To fulfill this need, Elementa provides [UITextInput](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/input/UITextInput.kt)
and [UIMultilineTextInput](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/input/UIMultilineTextInput.kt). Both
...
[WindowScreen](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/WindowScreen.kt)!)
...
[ScrollComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/ScrollComponent.kt). Scroll components have a fixed
...
A [MarkdownComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/markdown/MarkdownComponent.kt) is used to render
...
An [SVGComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/SVGComponent.kt) is used to render
...
The [PlotComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/graph/PlotComponent.kt), as its name implies,
...
[here](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/graph/GraphStyle.kt)!

### TreeListComponent

The [TreeListComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/TreeListComponent.kt) is a component which 
...
[TreeNode](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/TreeListComponent.kt) class. A node that simply displays 
some text
...
the [TreeArrowComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/TreeListComponent.kt) -- in the method 
...
The [TreeGraphComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/TreeGraphComponent.kt) has a similar API as 
...
The [Inspector](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/inspector/Inspector.kt) is a very handy tool used for
debugging/inspecting your Elementa GUIs. It is meant to be similar to a browser's "Inspect Element" tool. It uses a
[TreeListComponent](../src/main/kotlin/cc/polyfrost/oneconfig/libs/elementa/components/TreeListComponent.kt) to display the component hierarchy starting
