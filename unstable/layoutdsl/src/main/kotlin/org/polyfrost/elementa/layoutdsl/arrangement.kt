...
import org.polyfrost.elementa.utils.ObservableListEvent
...
interface Arrangement {
    ...
    companion object {
        ...
        fun spacedBy(spacing: Float = 0f, float: FloatPosition = FloatPosition.CENTER): Arrangement =
            SpacedArrangement.Factory(spacing, float)
...
private class EqualWeightArrangement(axis: Axis, spacing: Float) : SpacedArrangement(axis, spacing,
