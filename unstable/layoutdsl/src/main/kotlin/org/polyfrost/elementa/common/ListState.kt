...
import org.polyfrost.elementa.state.v2.collections.TrackedList
...
@Deprecated("Using StateV1 is discouraged, use StateV2 instead", ReplaceWith("mutableListState(state)", "org.polyfrost.elementa.state.v2.ListKt.mutableListState"))
...
@Deprecated("Using StateV1 is discouraged, use StateV2 instead", ReplaceWith("state.map", "org.polyfrost.elementa.state.v2.combinators.StateKt.map"))
