...
import org.polyfrost.elementa.constraints.ChildBasedMaxSizeConstraint
...
import org.polyfrost.elementa.dsl.boundTo
import org.polyfrost.elementa.dsl.childOf
import org.polyfrost.elementa.dsl.coerceAtLeast
import org.polyfrost.elementa.dsl.percent
import org.polyfrost.elementa.dsl.pixels
import org.polyfrost.elementa.common.HollowUIContainer
import org.polyfrost.elementa.common.constraints.AlternateConstraint
import org.polyfrost.elementa.common.constraints.SpacedCramSiblingConstraint
import org.polyfrost.universal.UMatrixStack
import org.polyfrost.elementa.state.v2.State
import org.polyfrost.elementa.state.v2.stateOf
...
fun LayoutScope.flowContainer(
    ...
    val childModifier = Modifier.then(BasicXModifier { SpacedCramSiblingConstraint(minSeparation(), 0.pixels) })
...
fun LayoutScope.scrollable(
    ...
    content.apply {
        ...
        setWidth(
            AlternateConstraint(ChildBasedSizeConstraint(), 100.percent boundTo outer).coerceAtLeast(
                AlternateConstraint(100.percent boundTo outer, 0.pixels)
            ))
        setHeight(
            AlternateConstraint(ChildBasedSizeConstraint(), 100.percent boundTo outer).coerceAtLeast(
                AlternateConstraint(100.percent boundTo outer, 0.pixels)
