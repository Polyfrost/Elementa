package org.polyfrost.elementa.util
...
import org.polyfrost.elementa.utils.ObservableAddEvent
import org.polyfrost.elementa.utils.ObservableClearEvent
import org.polyfrost.elementa.utils.ObservableList
import org.polyfrost.elementa.utils.ObservableRemoveEvent
import org.polyfrost.elementa.common.onSetValueAndNow
import org.polyfrost.elementa.state.v2.*
import org.polyfrost.elementa.state.v2.collections.MutableTrackedList
import org.polyfrost.universal.UMouse
import org.polyfrost.universal.UResolution
import org.polyfrost.elementa.state.v2.ListState as ListStateV2
 ...
 * one of them changes.
 */
@Deprecated("Using StateV1 is discouraged, use StateV2 instead", ReplaceWith("stateBy", "org.polyfrost.elementa.state.v2.StateByKt.stateBy"))
