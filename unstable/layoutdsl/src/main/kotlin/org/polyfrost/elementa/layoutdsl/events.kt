...
import org.polyfrost.elementa.util.Tag
import org.polyfrost.elementa.util.hoverScope
import org.polyfrost.elementa.util.makeHoverScope
import org.polyfrost.elementa.util.addTag
import org.polyfrost.elementa.util.removeTag

import org.polyfrost.elementa.state.State as StateV1
...
/** Declare this component and its children to be in a hover scope. See [makeHoverScope]. */
fun Modifier.hoverScope(state: State<Boolean>) =
    then { makeHoverScope(state); { throw NotImplementedError() } }
